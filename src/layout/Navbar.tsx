...
const Navbar = () => {
  ...
  return (
    <nav className="bg-litty-dark border-b border-gray-800 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <span className="text-2xl font-bold text-white tracking-wider">
                LITTY<span className="text-litty-accent">.</span>
              </span>
            </div>
          </div>
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <a href="#contact" className="bg-litty-accent hover:bg-litty-accent-hover text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-lg shadow-litty-accent/20">
                Book Now
              </a>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-litty-dark border-b border-gray-800">
            <a href="#services" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Services</a>
            <a href="#gallery" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Gallery</a>
            <a href="#testimonials" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Reviews</a>
            <a href="#contact" className="text-litty-accent hover:text-litty-accent-hover block px-3 py-2 rounded-md text-base font-bold">Book Now</a>
          </div>
        </div>
      )}
    </nav>
